...
#endif
{
  ...
  char*           newbrk;            /* return value from MORECORE */
  ...
  */
  ...
  newbrk = snd_brk = (char*)(MORECORE_FAILURE); 
  ...
  */
...
#if HAVE_MMAP
  if (newbrk == (char*)(MORECORE_FAILURE)) {
    ...
    if ((CHUNK_SIZE_T)(size) > (CHUNK_SIZE_T)(nb)) {
      ...
      newbrk = (char*)(MMAP(0, size, PROT_READ|PROT_WRITE, MAP_PRIVATE));
  ...
  if (newbrk != (char*)(MORECORE_FAILURE)) {
    ...
    */
    ...
    if (newbrk == old_end && snd_brk == (char*)(MORECORE_FAILURE)) {
    ...
    */
      ...
      */
      if (contiguous(av) && old_size != 0 && newbrk < old_end) {
        set_noncontiguous(av);
      }
      ...
      if (contiguous(av)) { 
        ...
        */
        if (old_size != 0) 
          av->sbrked_mem += newbrk - old_end;
        
        /* Guarantee alignment of first new chunk made from this space */

        front_misalign = (INTERNAL_SIZE_T)chunk2mem(newbrk) & MALLOC_ALIGN_MASK;
        if (front_misalign > 0) {
        ...
        */
        ...
        end_misalign = (INTERNAL_SIZE_T)(newbrk + size + correction);
      ...
      /* handle non-contiguous cases */
        ...
        assert(aligned_OK(chunk2mem(newbrk)));
        
        /* Find out current end of memory */
        if (snd_brk == (char*)(MORECORE_FAILURE)) {
          snd_brk = (char*)(MORECORE(0));
          av->sbrked_mem += snd_brk - newbrk - size;
        }
      }
...
#endif
{
  ...
  char*           newbrk;            /* alignment point within p */
  mchunkptr       newp;           /* chunk to return */
  INTERNAL_SIZE_T newsize;        /* its size */
  ...
  */
  ...
  if ((((PTR_UINT)(m)) % alignment) != 0) { /* misaligned */
    ...
    */
    ...
    newbrk = (char*)mem2chunk((PTR_UINT)(((PTR_UINT)(m + alignment - 1)) &
                           -((signed long) alignment)));
    if ((CHUNK_SIZE_T)(newbrk - (char*)(p)) < MINSIZE)
      newbrk += alignment;

    newp = (mchunkptr)newbrk;
    leadsize = newbrk - (char*)(p);
